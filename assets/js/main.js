...
// coverting string to DOM --------------------------------------------------


const parser = new DOMParser();
const parserHtml = parser.parseFromString(htmlData, 'text/html');

const tbody = parserHtml.getElementsByTagName('tbody')[0];
...
[...tbody.children].forEach(record => {
    ...
    // Make structure and push to rtoDate
    rtoDate.push({
        id: id,
        rto_code: recordChildren[0].innerText,
...
download(rtoDate, 'data.json', 'application/json' )
